...
@Autonomous(name="firstNewbieAuto")
//@Disabled

public class firstNewbieAuto extends LinearOpMode{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        robot.goToPos(26,0,Math.toRadians(-90),0);
        robot.goToPos(26,18,Math.toRadians(-90),0);

        robot.wait(5000,robot.odometers);

        //robot.goToPos(54,0,Math.toRadians(90),0);
        //robot.goToPos(54,-75,Math.toRadians(90),0);
        //robot.goToPos(124,-87,Math.toRadians(90),Math.toRadians(90));
